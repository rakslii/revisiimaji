...
<div class="bg-gradient-to-b from-gray-50 to-white min-h-screen">
        ...
        <div class="container mx-auto px-4 py-8 md:py-12 relative z-10">
            <div class="max-w-4xl">
                <nav class="flex items-center space-x-2 text-sm mb-6">
                    ...
                    <a href="{{ route('cart.index') }}" class="text-blue-200 hover:text-yellow-400 transition-colors">Keranjang</a>
                    <i class="fas fa-chevron-right text-blue-300 text-xs"></i>
    ...
    <div class="container mx-auto px-4 py-8 md:py-12">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="lg:w-2/3 space-y-6">
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-6 md:p-8 border border-gray-100">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-start p-4 rounded-xl border-2 border-gray-200 cursor-pointer hover:border-blue-500 transition-all group">
                                <input type="radio" name="shipping_method" value="pickup" class="mt-1 mr-4 w-5 h-5 accent-blue-600" checked>
                                <div class="flex-1">
                            ...
                            <label class="flex items-start p-4 rounded-xl border-2 border-gray-200 cursor-pointer hover:border-blue-500 transition-all group">
                                <input type="radio" name="shipping_method" value="delivery" class="mt-1 mr-4 w-5 h-5 accent-blue-600">
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-1">
                            ...
                            <label class="flex items-start p-4 rounded-xl border-2 border-gray-200 cursor-pointer hover:border-blue-500 transition-all group">
                                <input type="radio" name="shipping_method" value="cargo" class="mt-1 mr-4 w-5 h-5 accent-blue-600">
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-1">
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-6 md:p-8 border border-gray-100">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center p-4 rounded-xl border-2 border-gray-200 cursor-pointer hover:border-blue-500 transition-all group">
                                <input type="radio" name="payment_method" value="transfer" class="mr-4 w-5 h-5 accent-blue-600" checked>
                                <div class="flex-1">
                            ...
                            <label class="flex items-center p-4 rounded-xl border-2 border-gray-200 cursor-pointer hover:border-blue-500 transition-all group">
                                <input type="radio" name="payment_method" value="cash" class="mr-4 w-5 h-5 accent-blue-600">
                                <div class="flex-1">
                                    <div class="flex items-center">
                            ...
                            <label class="flex items-center p-4 rounded-xl border-2 border-gray-200 cursor-pointer hover:border-blue-500 transition-all group">
                                <input type="radio" name="payment_method" value="ewallet" class="mr-4 w-5 h-5 accent-blue-600">
                                <div class="flex-1">
                                    <div class="flex items-center">
                        ...
                        <div class="space-y-4 mb-6 max-h-64 overflow-y-auto">
                            ...
                            <div class="flex gap-3 pb-4 border-b border-gray-100">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="font-semibold text-gray-800 text-sm line-clamp-2">{{ $item->product->name }}</h4>
                                    <p class="text-gray-600 text-xs mt-1">Qty: {{ $item->quantity }}</p>
                                    <p class="text-blue-600 font-bold text-sm mt-1">Rp {{ number_format($item->price * $item->quantity, 0, ',', '.') }}</p>
                                </div>
                            </div>
                            @empty
        ...
        <!-- Help Section -->
        <div class="mt-12 relative bg-gradient-to-r from-blue-900 via-purple-900 to-blue-900 text-white rounded-3xl p-8 md:p-12 overflow-hidden">
            ...
            <div class="text-center relative z-10">
                <div class="w-16 h-16 bg-yellow-400 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-2xl">
