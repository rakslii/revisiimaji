...
<div class="absolute bottom-0 left-0 w-96 h-96 bg-[#7209b7] rounded-full opacity-10 blur-3xl"></div>
        ...
        <div class="container mx-auto px-4 py-8 md:py-12 relative z-10">
            <div class="max-w-4xl">
                <nav class="flex items-center space-x-2 text-sm mb-6">
                    <a href="{{ route('home') }}" class="text-blue-200 hover:text-[#193497] transition-colors">
    ...
    <div class="container mx-auto px-4 py-8 md:py-12">
        ...
        @if(session('error'))
        <div class="mb-6 bg-[#f91f01]/10 border-2 border-red-200 rounded-xl p-6">
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <ul class="mt-2 space-y-1 text-sm text-[#f91f01]">
        ...
        @if(empty($cartItems))
        <!-- Empty Cart -->
        <div class="bg-[#f9f0f1]rounded-3xl shadow-xl p-8 md:p-12 text-center border border-gray-100">
            <div class="w-24 h-24 bg-[#f9f0f1] border-2 border-[#193497] rounded-full flex items-center justify-center mx-auto mb-6">
                <i class="fas fa-shopping-cart text-[#7209b7] text-4xl"></i>
            </div>
            <h3 class="text-2xl font-bold text-[#191f01] mb-3">Keranjang Anda Kosong</h3>
            <p class="text-[#191f01]/70 max-w-md mx-auto mb-8 text-lg">
                Tambahkan produk yang Anda sukai ke keranjang untuk memulai belanja.
            </p>
            <a href="{{ route('products.index') }}" 
               class="inline-flex items-center px-8 py-4 bg-[#7209b7] hover:bg-[#f72585] text-white font-bold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            <!-- Cart Items -->
            <div class="lg:w-2/3">
                <div class="bg-[#f9f0f1] rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                    <div class="p-6 md:p-8 border-b border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-[#191f01]">Produk di Keranjang</h2>
                                <p class="text-[#191f01]/70 text-sm mt-1">{{ count($cartItems) }} produk</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-6">
                                ...
                                <div class="flex-1">
                                    <div class="flex flex-col sm:flex-row justify-between gap-4">
                                        <div class="flex-1">
                                            <h4 class="font-bold text-[#191f01] text-lg mb-2">{{ $cartItem['product']->name }}</h4>
                                            <div class="inline-block px-3 py-1 bg-[#d2f801] text-[#191f01] rounded-lg text-sm font-semibold mb-3">
                                                <i class="fas fa-tag mr-1"></i>
                                                {{ $cartItem['product']->category->name ?? 'Uncategorized' }}
                                            </div>
                                            
                                            @if(!$cartItem['available'])
                                            <div class="mt-3 flex items-center bg-[#f91f01]/10 text-[#f91f01] px-4 py-2 rounded-lg text-sm font-semibold">
                                        ...
                                        <div class="text-right">
                                            <p class="font-bold text-[#191f01] text-xl mb-1">{{ $cartItem['item']->formatted_price }}</p>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-6 gap-4">
                                        <div class="flex items-center gap-4">
                                            <form action="{{ route('cart.update', $cartItem['item']->id) }}" method="POST" class="flex items-center">
                                                ...
                                                <button type="button" 
                                                    ...
                                                    <i class="fas fa-minus text-[#191f01]/70"></i>
                                                </button>
                                                ...
                                                <input type="number" 
                                                       ...
                                                       class="w-16 h-10 text-center border-t-2 border-b-2 border-gray-300 focus:outline-none font-semibold text-[#191f01]"
                                                ...
                                                <button type="button" 
                                                    ...
                                                    <i class="fas fa-plus text-[#191f01]/70"></i>
                                                </button>
                                            </form>
                                            
                                            <div class="flex items-center bg-gray-100 px-3 py-2 rounded-lg">
                                                <i class="fas fa-warehouse text-[#191f01]/70 mr-2"></i>
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p class="font-bold text-[#191f01] text-xl">
                                            ...
                                            <form action="{{ route('cart.remove', $cartItem['item']->id) }}" method="POST">
                                                ...
                                                @method('DELETE')
                                                <button type="submit" 
                                                        class="w-10 h-10 flex items-center justify-center bg-[#f91f01]/10 hover:bg-[#f91f01]/20 text-red-500 hover:text-red-700 rounded-xl transition-all">
                    ...
                    <div class="p-6 md:p-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between gap-4">
                        ...
                        <form action="{{ route('cart.clear') }}" method="POST">
                            ...
                            <button type="submit" 
                                    ...
                                    class="px-6 py-3 border-2 border-[#f91f01] text-[#f91f01] font-bold rounded-xl hover:bg-[#f91f01]/10 transition-all inline-flex items-center">
            ...
            <!-- Order Summary -->
            <div class="lg:w-1/3">
                <div class="bg-[#f9f0f1]rounded-3xl shadow-xl p-6 md:p-8 sticky top-6 border border-gray-100">
                    <div class="flex items-center mb-6">
                        ...
                        <h2 class="text-xl font-bold text-[#191f01]">Ringkasan Pesanan</h2>
                    </div>
                    
                    <div class="space-y-4">
                        <div class="flex justify-between py-3 border-b border-gray-100">
                            <span class="text-[#191f01]/70 font-medium">Subtotal</span>
                            <span class="font-bold text-[#191f01]">{{ 'Rp ' . number_format($subtotal, 0, ',', '.') }}</span>
                        </div>
                        
                        <div class="flex justify-between py-3 border-b border-gray-100">
                            <span class="text-[#191f01]/70 font-medium">Pengiriman</span>
                            <span class="font-bold text-[#191f01]">Rp 15.000</span>
                        </div>
                        
                        <div class="flex justify-between py-3 border-b border-gray-100">
                            <span class="text-[#191f01]/70 font-medium">Diskon</span>
                            <span class="font-bold text-green-600">Rp 0</span>
                        </div>
                        
                        <div class="flex justify-between py-4 border-t-2 border-gray-200">
                            <span class="text-lg font-bold text-[#191f01]">Total</span>
                            <span class="text-2xl font-bold text-[#7209b7]">
                    ...
                    <div class="mt-8 space-y-4">
                        @if(auth()->check())
                            ...
                            @if($allAvailable)
                                <a href="{{ route('cart.checkout') }}" 
                                   class="block w-full py-4 bg-[#7209b7] hover:bg-[#f72585] text-white font-bold rounded-xl text-center transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                        ...
                        @else
                            ...
                            <p class="text-sm text-[#191f01]/70 text-center">
                                Atau <a href="{{ route('register') }}" class="text-[#7209b7] hover:underline font-semibold">buat akun baru</a>
                            </p>
                        @endif
                        
                        <div class="pt-6 border-t border-gray-100">
                            <h4 class="font-bold text-[#191f01] mb-4 flex items-center">
                                <i class="fas fa-credit-card text-[#7209b7] mr-2"></i>
                                Metode Pembayaran
                            </h4>
                            <div class="grid grid-cols-3 gap-3">
                                <div class="border-2 border-gray-200 rounded-xl p-3 text-center hover:border-green-500 hover:bg-green-50 transition-all cursor-pointer">
                                    <i class="fas fa-qrcode text-green-600 text-2xl mb-2"></i>
                                    <p class="text-xs font-bold text-gray-700">QRIS</p>
                                </div>
                                <div class="border-2 border-gray-200 rounded-xl p-3 text-center hover:border-blue-500 hover:bg-blue-50 transition-all cursor-pointer">
                                    <i class="fas fa-credit-card text-[#7209b7] text-2xl mb-2"></i>
                                    <p class="text-xs font-bold text-gray-700">Kartu</p>
                                </div>
                                <div class="border-2 border-gray-200 rounded-xl p-3 text-center hover:border-purple-500 hover:bg-purple-50 transition-all cursor-pointer">
                        ...
                        <div class="pt-6 border-t border-gray-100 space-y-3">
                            <div class="flex items-center text-sm text-[#191f01]/70">
