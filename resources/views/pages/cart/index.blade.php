        ...
        <div class="container mx-auto px-4 py-8 md:py-12 relative z-10">
            <div class="max-w-4xl">
                <nav class="flex items-center space-x-2 text-sm mb-6">
                    ...
                    <span class="text-yellow-400 font-semibold">Keranjang Belanja</span>
                </nav>

                <h1 class="text-3xl md:text-5xl font-bold mb-3 leading-tight">
                    <i class="fas fa-shopping-cart text-yellow-400 mr-3"></i>
                    Keranjang <span class="text-yellow-400">Belanja</span>
                </h1>
    ...
    <div class="container mx-auto px-4 py-8 md:py-12">
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 md:p-12 text-center border border-gray-100">
            ...
            <a href="{{ route('products.index') }}" 
               class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                ...
                <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                    <div class="p-6 md:p-8 border-b border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-gray-800">Produk di Keranjang</h2>
                            ...
                            <div class="flex flex-col sm:flex-row gap-6">
                                ...
                                <div class="flex-1">
                                    <div class="flex flex-col sm:flex-row justify-between gap-4">
                                        <div class="flex-1">
                                            <h4 class="font-bold text-gray-800 text-lg mb-2">{{ $cartItem['product']->name }}</h4>
                                            <div class="inline-block px-3 py-1 bg-blue-100 text-blue-700 rounded-lg text-sm font-semibold mb-3">
                                        ...
                                        <div class="text-right">
                                            <p class="font-bold text-gray-800 text-xl mb-1">{{ $cartItem['item']->formatted_price }}</p>
                                        ...
                                        <div class="flex items-center gap-4">
                                            <form action="{{ route('cart.update', $cartItem['item']->id) }}" method="POST" class="flex items-center">
                                                ...
                                                <input type="number" 
                                                       ...
                                                       class="w-16 h-10 text-center border-t-2 border-b-2 border-gray-300 focus:outline-none font-semibold text-gray-800"
                                            ...
                                            <div class="flex items-center bg-gray-100 px-3 py-2 rounded-lg">
                                                <i class="fas fa-warehouse text-gray-600 mr-2"></i>
                    ...
                    <div class="p-6 md:p-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between gap-4">
                        ...
                        <form action="{{ route('cart.clear') }}" method="POST">
                            ...
                            <button type="submit" 
                                    ...
                                    class="px-6 py-3 border-2 border-red-300 text-red-600 font-bold rounded-xl hover:bg-red-50 transition-all inline-flex items-center">
                    ...
                    <div class="mt-8 space-y-4">
                        @if(auth()->check())
                            ...
                            @if($allAvailable)
                                <a href="{{ route('cart.checkout') }}" 
                                   class="block w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold rounded-xl text-center transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                        ...
                        @else
                            ...
                            <p class="text-sm text-gray-600 text-center">
                                Atau <a href="{{ route('register') }}" class="text-blue-600 hover:underline font-semibold">buat akun baru</a>
                            </p>
                        @endif
