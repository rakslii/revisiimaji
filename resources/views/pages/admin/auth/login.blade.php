    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div class="p-8">
            <form method="POST" action="{{ route('admin.login.submit') }}">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            required
                            autofocus
                            class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 @error('email') border-red-500 @enderror"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            name="password"
                            required
                            class="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 @error('password') border-red-500 @enderror"
                            placeholder="••••••••"
                        >
                ...
                <div class="mt-6 text-center">
                    <a href="{{ url('/') }}" class="text-gray-600 hover:text-blue-600 text-sm font-medium">
        ...
        <div class="bg-gray-50 px-8 py-4 border-t border-gray-200 text-center">
            <p class="text-gray-500 text-sm">
                &copy; {{ date('Y') }} Cipta Imaji. All rights reserved.
            </p>
