                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between py-3 border-b border-gray-100">
                            ...
                            <span class="font-semibold text-blue-600">#{{ str_pad($user->id, 6, '0', STR_PAD_LEFT) }}</span>
                        </div>
                        <div class="flex items-center justify-between py-3 border-b border-gray-100">
                            <span class="text-gray-600">Bergabung</span>
                            <span class="font-semibold">{{ $user->created_at->translatedFormat('d F Y') }}</span>
                        </div>
                        <div class="flex items-center justify-between py-3 border-b border-gray-100">
            ...
            <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="p-4 bg-gray-50 rounded-xl border border-gray-200">
                                    ...
                                    <p class="text-gray-500 text-sm mt-1">{{ $primaryAddress->city }}, {{ $primaryAddress->province }} {{ $primaryAddress->postal_code }}</p>
                                    <p class="text-gray-500 text-sm mt-1">Penerima: {{ $primaryAddress->recipient_name }} ({{ $primaryAddress->recipient_phone }})</p>
                                </div>
                            </div>
                            @endif
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="border border-gray-200 rounded-xl p-5 hover:border-blue-300 transition-colors {{ $location->is_primary ? 'border-blue-300 bg-blue-50' : '' }}">
                            <div class="flex justify-between items-start mb-3">
                                <div class="flex items-center">
                                    <h4 class="font-bold text-gray-800">{{ $location->name }}</h4>
                                    @if($location->is_primary)
                                    <span class="ml-3 px-3 py-1 bg-blue-100 text-blue-600 text-xs font-semibold rounded-full">
                                        Utama
                                    </span>
                                    @endif
                                </div>
                                <div class="flex space-x-2">
                                    <button type="button" 
                                            onclick="editAddress({{ $location->id }})"
                                    ...
                                    <form method="POST" action="{{ route('profile.locations.delete', $location) }}" 
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100">
                                <form method="POST" action="{{ route('profile.locations.setPrimary', $location) }}">
                                    @csrf
                                    <button type="submit" 
