<footer class="bg-gray-900 text-white pt-12 pb-8">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="{{ route('whatsapp.chat') }}" target="_blank" class="text-gray-400 hover:text-white">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('products.index') }}?category=instan" class="text-gray-400 hover:text-white">Produk Instan</a></li>
                    <li><a href="{{ route('products.index') }}?category=non-instan" class="text-gray-400 hover:text-white">Produk Custom</a></li>
                    <li><a href="{{ route('whatsapp.chat') }}" target="_blank" class="text-gray-400 hover:text-white">Konsultasi</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
            <p>&copy; {{ date('Y') }} Cipta Imaji Digital Printing. All rights reserved.</p>
