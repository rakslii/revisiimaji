<aside class="fixed left-0 top-0 h-screen w-64 bg-gray-900 text-white shadow-lg">
    ...
    <nav class="p-4 space-y-2">
        <?php $__currentLoopData = [
            ...
            ['route' => 'admin.promo-codes.index', 'label' => 'Promo Codes', 'icon' => 'fas fa-tag'],
...
</aside><?php /**PATH F:\PROJECT-CODINGAN-CLIENT\revisiimaji\resources\views\pages\admin\layouts\sidebar.blade.php ENDPATH**/ ?>