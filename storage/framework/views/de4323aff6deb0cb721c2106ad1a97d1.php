...
<?php $__env->startSection('title', 'Keranjang Belanja - Cipta Imaji'); ?>
        ...
        <div class="mb-6 bg-red-50 border-2 border-red-200 rounded-xl p-6">
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <?php if(session('unavailable')): ?>
                    <ul class="mt-2 space-y-1 text-sm text-red-600">
                        <?php $__currentLoopData = session('unavailable'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="ml-4 list-disc"><?php echo e($message); ?></li>
                    ...
                    <div class="p-6 md:p-8 border-b border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm mt-1"><?php echo e(count($cartItems)); ?> produk</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-6">
                                ...
                                <div class="flex-1">
                                    <div class="flex flex-col sm:flex-row justify-between gap-4">
                                        <div class="flex-1">
                                            <h4 class="font-bold text-gray-900 text-lg mb-2"><?php echo e($cartItem['product']->name); ?></h4>
                                        ...
                                        <div class="text-right">
                                            <p class="font-bold text-gray-900 text-xl mb-1"><?php echo e($cartItem['item']->formatted_price); ?></p>
                                            <?php if($cartItem['product']->price != $cartItem['item']->price): ?>
                                            <p class="text-sm text-gray-500 line-through">Rp <?php echo e(number_format($cartItem['product']->price, 0, ',', '.')); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-6 gap-4">
                                        <div class="flex items-center gap-4">
                                            <form action="<?php echo e(route('cart.update', $cartItem['item']->id)); ?>" method="POST" class="flex items-center">
                                                <?php echo csrf_field(); ?>
                                                <button type="button" 
                                                        onclick="updateQuantity(<?php echo e($cartItem['item']->id); ?>, -1)"
                                                ...
                                                <input type="number" 
                                                       id="quantity-<?php echo e($cartItem['item']->id); ?>"
                                                       name="quantity"
                                                       ...
                                                       onchange="submitQuantity(<?php echo e($cartItem['item']->id); ?>)">
                                            ...
                                            <div class="flex items-center bg-gray-100 px-3 py-2 rounded-lg">
                                                ...
                                                <span class="text-sm text-gray-700 font-semibold">
                                                    Stok: <?php echo e($cartItem['product']->stock); ?>
                                        ...
                                        <div class="flex items-center gap-4">
                                            <p id="total-<?php echo e($cartItem['item']->id); ?>" class="font-bold text-gray-900 text-xl">
                                                <?php echo e('Rp ' . number_format($cartItem['total'], 0, ',', '.')); ?>

                                            </p>
                                            
                                            <form action="<?php echo e(route('cart.remove', $cartItem['item']->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between py-3 border-b border-gray-100">
                            ...
                            <span id="subtotal" class="font-bold text-gray-900">
                                <?php echo e('Rp ' . number_format($subtotal, 0, ',', '.')); ?>
                        ...
                        <div class="flex justify-between py-4 border-t-2 border-gray-200">
                            ...
                            <span id="grand-total" class="text-2xl font-bold text-[#193497]">
                                <?php echo e('Rp ' . number_format($subtotal + 15000, 0, ',', '.')); ?>
                    ...
                    <div class="mt-8 space-y-4">
                            ...
                            <div class="p-4 bg-yellow-50 border-2 border-yellow-200 rounded-xl">
                                <div class="flex items-start">
                                    ...
                                    <p class="text-sm text-yellow-700">
                                        ...
                                        <a href="<?php echo e(route('profile.index')); ?>" class="underline font-bold hover:text-yellow-800">Tambahkan alamat</a> sebelum checkout.
                                    </p>
                                </div>
                            </div>
                            <?php endif; ?>
                        <?php else: ?>
                            ...
                            <p class="text-sm text-gray-600 text-center">
                                Atau <a href="<?php echo e(route('register')); ?>" class="text-[#193497] hover:underline font-semibold">buat akun baru</a>
                            </p>
                        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT-CODINGAN-CLIENT\revisiimaji\resources\views\pages\cart\index.blade.php ENDPATH**/ ?>