    ...
    <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="group hover-lift smooth-transition" style="animation-delay: <?php echo e($value['delay']); ?>;">
                    <div class="bg-white border-2 border-gray-100 rounded-3xl p-8 hover:border-transparent hover:shadow-2xl smooth-transition h-full">
                        <div class="w-16 h-16 bg-gradient-to-br <?php echo e($value['gradient']); ?> rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 smooth-transition">
                            <i class="fas <?php echo e($value['icon']); ?> text-white text-2xl"></i>
                        </div>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="group hover-lift smooth-transition <?php echo e('stagger-' . ($loop->index + 1)); ?>">
                    <div class="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl smooth-transition border border-gray-100 hover:border-transparent card-tilt">
                        <!-- Avatar -->
                        <div class="w-24 h-24 bg-gradient-to-br <?php echo e($member['gradient']); ?> rounded-2xl flex items-center justify-center text-white font-bold text-3xl mx-auto mb-6 group-hover:scale-110 smooth-transition">
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-sm font-semibold text-[#193497] mb-4"><?php echo e($member['role']); ?></div>
                            <p class="text-gray-600 text-sm leading-relaxed"><?php echo e($member['desc']); ?></p>
                        </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="text-center animate-fade-in-up" style="animation-delay: <?php echo e($index * 0.1); ?>s;">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 group">
                        ...
                        <div class="text-5xl font-bold text-white mb-2"><?php echo e($stat['number']); ?></div>
                        <div class="text-white/80"><?php echo e($stat['label']); ?></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="group hover-lift smooth-transition <?php echo e('stagger-' . ($loop->index + 3)); ?>">
                    <div class="bg-gradient-to-br <?php echo e($tech['gradient']); ?> rounded-3xl p-8 hover:shadow-2xl smooth-transition">
                        <div class="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 smooth-transition">
                            <i class="fas <?php echo e($tech['icon']); ?> text-white text-2xl"></i>
                        </div>
                        
                        <h3 class="text-2xl font-bold text-white mb-4"><?php echo e($tech['title']); ?></h3>
                        <p class="text-white/90 leading-relaxed"><?php echo e($tech['desc']); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
