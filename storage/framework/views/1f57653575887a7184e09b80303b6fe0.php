...
<?php $__env->startSection('page-description', 'Manage discount codes and product promotions'); ?>
...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mt-1"><?php echo e(\App\Models\PromoCode::count()); ?></h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mt-1"><?php echo e(\App\Models\ProductPromotion::count()); ?></h3>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mt-1">
                        <?php echo e(\App\Models\PromoCode::where('is_active', true)
            ...
            <div class="mt-3">
                <span class="text-sm text-gray-600">
                    <?php echo e(\App\Models\PromoCode::where('is_active', true)
                        ...
                        ->whereRaw('used_count < quota')
                        ->count()); ?> codes + 
                    <?php echo e(\App\Models\ProductPromotion::where('is_active', true)
                        ->where('valid_from', '<=', now())
                        ->where('valid_until', '>=', now())
                        ->where(function($q) {
                            $q->whereNull('quota')->orWhereRaw('used_count < quota');
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mt-1">
                        <?php echo e(\App\Models\ProductPromotion::where('valid_until', '<=', now()->addDays(7))
                            ->where('valid_until', '>=', now())
            ...
            <div class="mt-3">
                <a href="<?php echo e(route('admin.product-promotions.index')); ?>?status=active" 
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="border-b border-gray-200">
            <nav class="flex -mb-px">
                <a href="<?php echo e(route('admin.promos.index')); ?>" 
                   class="<?php echo e(request()->routeIs('admin.promos.*') && !request()->is('*/product-promotions*') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?> flex-1 py-4 px-1 text-center border-b-2 font-medium text-sm">
                    <i class="fas fa-ticket-alt mr-2"></i> Promo Codes
                </a>
                <a href="<?php echo e(route('admin.product-promotions.select-product')); ?>" 
                   class="<?php echo e(request()->is('*/product-promotions*') ? 'border-green-500 text-green-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?> flex-1 py-4 px-1 text-center border-b-2 font-medium text-sm">
                    <i class="fas fa-tag mr-2"></i> Product Promotions
                </a>
                <a href="<?php echo e(route('admin.product-promotions.index')); ?>" 
                   class="<?php echo e(request()->routeIs('admin.product-promotions.index') ? 'border-purple-500 text-purple-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?> flex-1 py-4 px-1 text-center border-b-2 font-medium text-sm">
    ...
    <?php if(request()->routeIs('admin.promos.*') && !request()->is('*/product-promotions*')): ?>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="promo-type-badge <?php echo e($promo->type == 'percentage' ? 'type-percentage' : 'type-nominal'); ?>">
    ...
    <?php elseif(request()->is('*/product-promotions*')): ?>
