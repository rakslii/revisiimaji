...
<?php $__env->startSection('title', 'Consultation Settings'); ?>
<?php $__env->startSection('page-title', 'Consultation Settings'); ?>
<?php $__env->startSection('page-description', 'Manage WhatsApp consultation links'); ?>
    ...
    <div class="tab-contents">
        ...
        <div id="general" class="tab-content active">
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <form action="<?php echo e(route('admin.settings.consultations.general.update', $general->id)); ?>" method="POST" class="p-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" 
                                   name="phone_number" 
                                   value="<?php echo e(old('phone_number', $general->phone_number)); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="display_text" 
                                   value="<?php echo e(old('display_text', $general->display_text)); ?>"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="message_template" 
                                  rows="4"
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Halo, saya ingin konsultasi. Bisa dibantu?"><?php echo e(old('message_template', $general->message_template)); ?></textarea>
                    ...
                    <div class="flex items-center mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" 
                                   name="is_active" 
                                   value="1"
                                   <?php echo e($general->is_active ? 'checked' : ''); ?>
        ...
        <div id="product" class="tab-content hidden">
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <form action="<?php echo e(route('admin.settings.consultations.product.update', $product->id)); ?>" method="POST" class="p-6">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" 
                                   name="phone_number" 
                                   value="<?php echo e(old('phone_number', $product->phone_number)); ?>"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   placeholder="6281234567890">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="display_text" 
                                   value="<?php echo e(old('display_text', $product->display_text)); ?>"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="message_template" 
                                  rows="4"
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Halo, saya tertarik dengan produk *[PRODUCT_NAME]*. Bisa info lebih lanjut?"><?php echo e(old('message_template', $product->message_template)); ?></textarea>
                    ...
                    <div class="mb-6 space-y-2">
                        <label class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   <?php echo e($product->include_product_url ? 'checked' : ''); ?>
        ...
        <div id="custom" class="tab-content hidden">
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <form action="<?php echo e(route('admin.settings.consultations.custom.update', $custom->id)); ?>" method="POST" class="p-6">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" 
                                   name="phone_number" 
                                   value="<?php echo e(old('phone_number', $custom->phone_number)); ?>"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   placeholder="6281234567890">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="display_text" 
                                   value="<?php echo e(old('display_text', $custom->display_text)); ?>"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="message_template" 
                                  rows="4"
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Halo, saya ingin konsultasi tentang produk custom *[PRODUCT_NAME]*. Bisa dibantu?"><?php echo e(old('message_template', $custom->message_template)); ?></textarea>
                        <p class="text-xs text-gray-500 mt-2">
                            <span class="font-semibold">Available variables:</span><br>
                    ...
                    <div class="flex items-center mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" 
                                   name="is_active" 
                                   value="1"
                                   <?php echo e($custom->is_active ? 'checked' : ''); ?>
...
<div class="mt-8 bg-gray-50 rounded-lg p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-white p-4 rounded-lg border">
            ...
            <a href="<?php echo e($general->getWhatsAppUrl()); ?>" target="_blank" 
               class="text-green-600 hover:text-green-800 flex items-center">
                <i class="fab fa-whatsapp mr-2"></i>
                <?php echo e($general->display_text); ?>
        ...
        <div class="bg-white p-4 rounded-lg border">
            ...
            <a href="<?php echo e($product->getWhatsAppUrl(new \App\Models\Product())); ?>" target="_blank" 
               class="text-green-600 hover:text-green-800 flex items-center">
                <i class="fab fa-whatsapp mr-2"></i>
                <?php echo e($product->display_text); ?>
        ...
        <div class="bg-white p-4 rounded-lg border">
            ...
            <a href="<?php echo e($custom->getWhatsAppUrl('Contoh Produk Custom')); ?>" target="_blank" 
               class="text-green-600 hover:text-green-800 flex items-center">
                <i class="fab fa-whatsapp mr-2"></i>
                <?php echo e($custom->display_text); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('pages.admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\revisiimaji\resources\views/pages/admin/settings/consultations/index.blade.php ENDPATH**/ ?>