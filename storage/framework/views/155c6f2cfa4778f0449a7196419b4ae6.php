...
<?php $__env->startSection('title', 'Create Product Promotion'); ?>
<?php $__env->startSection('page-title', 'Create Promotion for ' . $product->name); ?>
<?php $__env->startSection('page-description', 'Set up special promotion for this product'); ?>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="p-6">
                <div class="flex items-start gap-4">
                    ...
                    <!-- Product Details -->
                    <div class="flex-1">
                        <h2 class="text-xl font-bold text-gray-800"><?php echo e($product->name); ?></h2>
                        <div class="mt-2 space-y-1">
                            ...
                            <div class="text-sm text-gray-600">
                                <span class="inline-flex items-center gap-1">
                                    <i class="fas fa-box"></i> Stock: <?php echo e($product->stock); ?>
...
<div class="text-right">
    ...
    <div class="text-2xl font-bold text-green-600">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="p-6">
                <form action="<?php echo e(route('admin.product-promotions.store', $product->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                                ...
                                <div>
                                    ...
                                    <select name="promo_code_id" 
                                        ...
                                        <?php $__currentLoopData = $promoCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($promo->id); ?>" <?php echo e(old('promo_code_id') == $promo->id ? 'selected' : ''); ?>>
                                                <?php echo e($promo->code); ?> - <?php echo e($promo->name); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">
                                        Max nominal: Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?>
...
<?php echo $__env->make('pages.admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\revisiimaji\resources\views/pages/admin/promos/product-promotions/create.blade.php ENDPATH**/ ?>