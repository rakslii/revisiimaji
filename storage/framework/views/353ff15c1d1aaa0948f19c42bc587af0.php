...
<section class="py-12 bg-gradient-to-r from-[#193497]/5 to-[#720e87]/5">
    <div class="container mx-auto px-4">
        ...
        <?php if($bannerCount == 1): ?>
            ...
            <?php $__currentLoopData = $homeBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="group relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-700 hover:-translate-y-2 cursor-pointer" 
                                ...
                                <div class="max-w-2xl">
                                    ...
                                    <div class="transform group-hover:translate-x-2 transition-transform duration-1000">
                                        <span class="inline-flex items-center bg-[#c0f820] text-[#193497] px-8 py-4 rounded-full font-bold text-lg hover:bg-[#d4ff40] transition-all duration-300 shadow-xl">
                                            <?php echo e($banner->button_text ?? 'Lihat Promo'); ?>
                    ...
                    <div class="h-[400px] md:h-[500px] bg-gradient-to-r from-[#193497] to-[#720e87] flex items-center">
                        <div class="container mx-auto px-8">
                            <div class="max-w-2xl">
                                <?php if($banner->subtitle): ?>
                                <p class="text-[#c0f820] font-semibold text-lg mb-3"><?php echo e($banner->subtitle); ?></p>
                                <?php endif; ?>
                                <?php if($banner->title): ?>
                                <h3 class="text-4xl md:text-5xl font-bold text-white mb-4"><?php echo e($banner->title); ?></h3>
                                <?php endif; ?>
                                <?php if($banner->description): ?>
                                <p class="text-white/90 text-lg mb-6"><?php echo e($banner->description); ?></p>
                                <?php endif; ?>
                                <?php if($banner->link): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 cursor-pointer h-[350px]"
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                        <?php if($banner->subtitle): ?>
                        <p class="text-sm text-[#c0f820] font-semibold mb-2"><?php echo e($banner->subtitle); ?></p>
                        <?php endif; ?>
                        <?php if($banner->title): ?>
                        <h3 class="text-2xl font-bold mb-2"><?php echo e($banner->title); ?></h3>
                        <?php endif; ?>
                        <?php if($banner->description): ?>
                        <p class="text-sm text-white/90 mb-3 line-clamp-2"><?php echo e($banner->description); ?></p>
                        <?php endif; ?>
        ...
        <?php elseif($bannerCount == 3): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 cursor-pointer <?php echo e($index == 0 ? 'md:col-span-2 md:row-span-1 h-[350px] md:h-[400px]' : 'h-[250px] md:h-[190px]'); ?>"
                     onclick="location='/products?sort=discount&page=1'"
                     data-banner-id="<?php echo e($banner->id); ?>">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                        <?php if($banner->subtitle): ?>
                        <p class="text-xs text-[#c0f820] font-semibold mb-1"><?php echo e($banner->subtitle); ?></p>
                        <?php endif; ?>
                        <h3 class="font-bold <?php echo e($index == 0 ? 'text-2xl' : 'text-xl'); ?> mb-2"><?php echo e($banner->title); ?></h3>
                        <?php if($index == 0 && $banner->description): ?>
                        <p class="text-sm text-white/90 mb-3 line-clamp-2"><?php echo e($banner->description); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <?php else: ?>
            ...
            <div class="relative" x-data="{ currentSlide: 0 }" x-init="setInterval(() => { currentSlide = (currentSlide + 1) % <?php echo e($bannerCount); ?> }, 5000)">
                <!-- Slides -->
                                ...
                                <div class="absolute inset-0 flex items-center">
                                    <div class="container mx-auto px-8">
                                        <div class="max-w-2xl">
                                            ...
                                            <?php endif; ?>
                                            <?php if($banner->description): ?>
                                            <p class="text-white/90 text-lg mb-6 max-w-xl"><?php echo e($banner->description); ?></p>
                                            <?php endif; ?>
                                            <?php if($banner->link): ?>
                ...
                <div class="flex justify-center mt-4 space-x-2">
                    ...
                    <button @click="currentSlide = <?php echo e($index); ?>"
                            ...
                            :class="{ 'w-8 bg-[#193497]' : currentSlide === <?php echo e($index); ?>, 'bg-gray-300' : currentSlide !== <?php echo e($index); ?> }">
                    </button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                
                <!-- Navigation Arrows -->
                <button @click="currentSlide = (currentSlide - 1 + <?php echo e($bannerCount); ?>) % <?php echo e($bannerCount); ?>"
                ...
                <button @click="currentSlide = (currentSlide + 1) % <?php echo e($bannerCount); ?>"
            ...
            <div class="group bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-700 text-sm mb-4 line-clamp-2">
                        <?php echo e(Illuminate\Support\Str::limit($product->description, 60)); ?>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="font-bold text-2xl text-[#193497]">
                                <?php echo e(number_format($product->final_price / 1000, 0)); ?>K
                            </div>
                            <?php else: ?>
                            <div class="font-bold text-2xl text-[#193497]">
                                <?php echo e(number_format($product->price / 1000, 0)); ?>K
            ...
            <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-transparent overflow-hidden">
                ...
                <div class="relative h-48 overflow-hidden">
                    ...
                    <div class="w-full h-full bg-gradient-to-br from-[#193497] to-[#720e87] flex items-center justify-center">
                        <i class="fas <?php echo e($category->icon ?? 'fa-image'); ?> text-white/40 text-4xl"></i>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="absolute top-3 right-3 flex space-x-1">
                        <?php for($i = 2; $i <= 4; $i++): ?>
                            ...
                            <div class="w-8 h-8 rounded-md bg-gradient-to-br 
                                <?php if($i == 2): ?> from-[#c0f820] to-[#d4ff40]
                                <?php elseif($i == 3): ?> from-[#f72585] to-[#ec4899]
                                <?php else: ?> from-[#ff0f0f] to-[#f87171]
                                <?php endif; ?>
                    ...
                    <div class="absolute bottom-3 left-3">
                        ...
                        <div class="w-10 h-10 bg-white/90 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-lg">
                            <i class="fas <?php echo e($category->icon); ?> text-[#193497] text-lg"></i>
                        </div>
                        <?php endif; ?>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\revisiimaji\resources\views/pages/home/index.blade.php ENDPATH**/ ?>