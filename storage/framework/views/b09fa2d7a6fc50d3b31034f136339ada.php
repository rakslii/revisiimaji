...
<?php $__env->startSection('page-description', 'Add a new discount code'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" id="value" name="value" value="<?php echo e(old('value')); ?>" step="0.01"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="min_purchase" name="min_purchase" value="<?php echo e(old('min_purchase')); ?>" step="1000"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="quota" name="quota" value="<?php echo e(old('quota', 100)); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="border-b pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="valid_from" name="valid_from" value="<?php echo e(old('valid_from')); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="valid_until" name="valid_until" value="<?php echo e(old('valid_until')); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   required>
