...
<div id="valueModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-lg bg-white">
        ...
        <form id="form-value" method="POST" action="<?php echo e(route('admin.settings.about-us.core-values.store')); ?>">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\laragon\www\revisiimaji\resources\views/pages/admin/settings/about-us/modals/value.blade.php ENDPATH**/ ?>