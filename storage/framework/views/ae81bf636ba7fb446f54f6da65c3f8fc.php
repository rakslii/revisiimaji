                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-800"><?php echo e($product->sales_count); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-800"><?php echo e($product->rating ?? 'N/A'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-800"><?php echo e($product->min_order); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <?php if($product->discount_percent > 0): ?>
                                <div class="mt-2">
                                    ...
                                    <p class="text-xl font-bold text-green-600">
                                        Rp <?php echo e(number_format($product->discounted_price, 0, ',', '.')); ?>
    ...
    <div class="bg-gray-50 rounded-lg overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            <tbody class="divide-y divide-gray-200">
                ...
                <?php if(is_array($specifications) && count($specifications) > 0): ?>
...
<?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t">
                        <div>
                            ...
                            <p class="text-gray-700"><?php echo e($product->created_at->format('d M Y H:i')); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Last Updated</p>
                            <p class="text-gray-700"><?php echo e($product->updated_at->format('d M Y H:i')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="px-6 py-4 border-b flex justify-between items-center">
                    ...
                    <span class="px-3 py-1 text-xs font-semibold rounded-full 
                        <?php echo e($product->stock > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
