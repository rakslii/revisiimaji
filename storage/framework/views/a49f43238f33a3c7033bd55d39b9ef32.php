<div class="p-6">
    ...
    <?php if($sections->count() > 0): ?>
        <div class="sections-list space-y-4">
            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50" data-id="<?php echo e($section->id); ?>">
                    <div class="flex items-start justify-between">
                        ...
                        <div class="flex space-x-2">
                            <button onclick='editSection(<?php echo json_encode($section, 15, 512) ?>)'
                                    class="text-green-600 hover:text-green-800 p-2">
                                <i class="fas fa-edit"></i>
                            </button>
                            
                            <form action="<?php echo e(route('admin.settings.about-us.sections.toggle-status', $section->id)); ?>" 
                                  method="POST" 
                                  class="inline">
                                <?php echo csrf_field(); ?>
                                <button type="submit" 
    ...
    <?php endif; ?>
</div><?php /**PATH C:\laragon\www\revisiimaji\resources\views/pages/admin/settings/about-us/tabs/sections.blade.php ENDPATH**/ ?>