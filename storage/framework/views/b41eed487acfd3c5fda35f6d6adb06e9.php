...
<body class="font-sans bg-gray-50">
    ...
    <!-- modal-->
   <?php echo $__env->make('components.promo-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/app.js', 'resources/js/promo.js']); ?>
