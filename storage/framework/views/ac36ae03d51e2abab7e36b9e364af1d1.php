                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-2">
                            <a href="<?php echo e(route('products.index')); ?>"
                               class="group flex items-center px-4 py-3 rounded-xl transition-all duration-300 <?php echo e(!request('category') ? 'bg-[#193497] text-white shadow-lg' : 'text-gray-600 hover:bg-gray-50'); ?>"
                            ...
                            <a href="#"
                               ...
                               class="group flex items-center px-4 py-3 rounded-xl transition-all duration-300 <?php echo e(request('category') == 'instan' ? 'bg-blue-50 text-[#193497] font-semibold border-2 border-[#193497]/30' : 'text-gray-600 hover:bg-gray-50'); ?>">
                            ...
                            <a href="#"
                               ...
                               class="group flex items-center px-4 py-3 rounded-xl transition-all duration-300 <?php echo e(request('category') == 'non-instan' ? 'bg-purple-50 text-[#7209b7] font-semibold border-2 border-purple-200' : 'text-gray-600 hover:bg-gray-50'); ?>">
                        ...
                        <div>
                            <h2 class="text-3xl font-bold text-gray-800 mb-2" id="resultsTitle">
                                ...
                                <?php elseif(request('category')): ?>
                                    <?php if($selectedCategory == 'instan'): ?>
                                        <i class="fas fa-bolt text-[#193497] mr-2"></i>
                                        Produk Instan
                                    <?php elseif($selectedCategory == 'non-instan'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\PROJECT-CODINGAN-CLIENT\revisiimaji\resources\views/pages/products/index.blade.php ENDPATH**/ ?>