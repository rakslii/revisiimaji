            ...
            <div class="max-w-4xl mx-auto text-center hero-content">
                ...
                <div class="grid grid-cols-3 gap-6 max-w-xl mx-auto stats-grid">
                    <div class="text-center">
                        <div class="text-3xl md:text-4xl font-bold text-[#d2f801] mb-1"><?php echo e($products->total()); ?>+</div>
            ...
            <div class="lg:w-1/4">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-6 filter-sidebar">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <button type="button"
                                   ...
                                   class="w-full group flex items-center px-4 py-3 rounded-xl transition-all duration-300 <?php echo e(!request('category') ? 'bg-[#193497] text-white' : 'text-gray-700 hover:bg-gray-50'); ?>">
                            ...
                            <button type="button"
                                   ...
                                   class="w-full group flex items-center px-4 py-3 rounded-xl transition-all duration-300 <?php echo e(request('category') == 'instan' ? 'bg-[#193497]/10 text-[#193497] font-medium border border-[#193497]/20' : 'text-gray-700 hover:bg-gray-50'); ?>">
                            ...
                            <button type="button"
                                   ...
                                   class="w-full group flex items-center px-4 py-3 rounded-xl transition-all duration-300 <?php echo e(request('category') == 'non-instan' ? 'bg-[#7209b7]/10 text-[#7209b7] font-medium border border-[#7209b7]/20' : 'text-gray-700 hover:bg-gray-50'); ?>">
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        ...
                        <div id="sortForm">
                            <div class="space-y-2">
                                <label class="flex items-center px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 <?php echo e($selectedSort == 'latest' ? 'bg-[#193497]/5 border border-[#193497]/20' : 'hover:bg-gray-50'); ?>">
                                    ...
                                    <span class="text-sm <?php echo e($selectedSort == 'latest' ? 'text-[#193497] font-medium' : 'text-gray-700'); ?>">Terbaru</span>
                                </label>
                                <label class="flex items-center px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 <?php echo e($selectedSort == 'popular' ? 'bg-[#193497]/5 border border-[#193497]/20' : 'hover:bg-gray-50'); ?>">
                                    <input type="radio" name="sort" value="popular"
                                           <?php echo e($selectedSort == 'popular' ? 'checked' : ''); ?>

                                           onchange="applyFilter('sort', 'popular')"
                                           class="mr-3 w-4 h-4 text-[#193497] focus:ring-[#193497] border-gray-300">
                                    <span class="text-sm <?php echo e($selectedSort == 'popular' ? 'text-[#193497] font-medium' : 'text-gray-700'); ?>">Terlaris</span>
                                </label>
                                <label class="flex items-center px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 <?php echo e($selectedSort == 'price_asc' ? 'bg-[#193497]/5 border border-[#193497]/20' : 'hover:bg-gray-50'); ?>">
                                    <input type="radio" name="sort" value="price_asc"
                                           <?php echo e($selectedSort == 'price_asc' ? 'checked' : ''); ?>

                                           onchange="applyFilter('sort', 'price_asc')"
                                           class="mr-3 w-4 h-4 text-[#193497] focus:ring-[#193497] border-gray-300">
                                    <span class="text-sm <?php echo e($selectedSort == 'price_asc' ? 'text-[#193497] font-medium' : 'text-gray-700'); ?>">Harga Terendah</span>
                                </label>
                                <label class="flex items-center px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 <?php echo e($selectedSort == 'price_desc' ? 'bg-[#193497]/5 border border-[#193497]/20' : 'hover:bg-gray-50'); ?>">
                                    <input type="radio" name="sort" value="price_desc"
                                           ...
                                           class="mr-3 w-4 h-4 text-[#193497] focus:ring-[#193497] border-gray-300">
                                    <span class="text-sm <?php echo e($selectedSort == 'price_desc' ? 'text-[#193497] font-medium' : 'text-gray-700'); ?>">Harga Tertinggi</span>
                                </label>
                                <label class="flex items-center px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 <?php echo e($selectedSort == 'discount' ? 'bg-[#193497]/5 border border-[#193497]/20' : 'hover:bg-gray-50'); ?>">
                                    <input type="radio" name="sort" value="discount"
                                           <?php echo e($selectedSort == 'discount' ? 'checked' : ''); ?>

                                           onchange="applyFilter('sort', 'discount')"
                                           class="mr-3 w-4 h-4 text-[#193497] focus:ring-[#193497] border-gray-300">
                                    <span class="text-sm <?php echo e($selectedSort == 'discount' ? 'text-[#193497] font-medium' : 'text-gray-700'); ?>">Diskon Terbesar</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 bg-gradient-to-br from-[#f91f01] to-[#ff4500] text-white rounded-xl p-6 text-center promo-banner">
                        ...
                        <a href="<?php echo e(route('whatsapp.chat')); ?>" target="_blank" class="inline-block bg-white text-[#f91f01] px-6 py-2.5 rounded-lg font-bold text-sm hover:bg-gray-100 transition-all">
                            Klaim Sekarang
                        </a>
                    </div>
                </div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 p-12 text-center">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <a href="<?php echo e(route('whatsapp.chat')); ?>" target="_blank" class="bg-[#25D366] hover:bg-[#128C7E] text-white px-6 py-3 rounded-xl font-medium transition-all">
